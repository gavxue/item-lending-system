    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-center my-5">
                <a className="btn btn-primary btn-lg fs-2 me-5" href="/loan" role="button">Loan an item</a>
                <a className="btn btn-primary btn-lg fs-2" href="/return" role="button">Return an item</a>
            </div>
            <div className="my-5">
